...
// - 로그인 화면에서 회원가입 / 아이디 찾기 / 비밀번호 찾기 흐름으로 연결
  ...
  return (
    <main className="signup-page">
      <section className="signup-hero">
        <Link to="/login" className="signup-outline-button">
          ← 로그인 화면으로 돌아가기
        </Link>
      ...
      <section className="signup-info-box">
        ...
        <div className="signup-room-guide">
          ...
          <div>
            <strong>소상공인 로그인</strong>
            <span>사업자번호 또는 이메일로 로그인 가능</span>
          </div>
        </div>
      </section>
    </main>
